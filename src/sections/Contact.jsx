    ...
    <section id="contact" className="relative bg-black min-h-screen flex items-center justify-center text-white">
      <div className="w-full flex flex-col md:flex-row gap-12 md:gap-20 items-start justify-center z-10 mt-12 md:mt-0">
        <div className="flex-1 flex flex-col items-start max-w-lg">
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight pb-4 border-b-2 border-sky-500 text-center mb-10">
            Contact
          </h2>
          <p className="text-gray-400 text-md sm:text-lg leading-relaxed mb-10">
        ...
        <div className="relative flex-1 w-full md:max-w-md bg-gray-900 rounded-xl p-8 shadow-xl">
          <Light className='!-z-10' />
					<h3 className="text-xl sm:text-2xl lg:text-4xl font-extrabold tracking-tight pb-4 mb-4 border-b-[1px] border-sky-500">
						Contact Form
					</h3>
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full flex items-center justify-center space-x-2 bg-gray-950 hover:bg-sky-500 text-white font-semibold py-4 px-6 rounded-lg transition-colors duration-300 border border-gray-700 hover:border-white hover:text-white"
            >
